    ...
    for cnt in contors:
        ...
        if area>500:    #all shapes greater than 50 pixels
            ...
            if objCor == 3: objectType = "Tri"
                ...
                if aspectRatio > 0.95 and aspectRatio < 1.05:  objectType="Squre"
...
#find boundries and shapes
imgCanny = cv2.Canny(img,100,100)
#make the borders thikker
imgDilation = cv2.dilate(imgCanny, kernel, iterations=1 )
#make the borders thinnr
...
imgText = cv2.putText(img, "what a circles", (150,500), cv2.FONT_HERSHEY_COMPLEX, 2, (98,0,46),2)
    ...
    # cv2.putText(img, "what a circles", (150,500), cv2.FONT_HERSHEY_COMPLEX, size of text , (98,0,46),thickenss of text)
...
image2[200:300, 250:350]=255,0,0
    #to colour ony a part of imageusing array index
cv2.imshow("Image", image2)
cv2.waitKey(1000)
...
cv2.rectangle(image2,(1,1), (100,122), (96,56,163), cv2.FILLED)
    #to fill rectange with a colour
cv2.imshow("Image", image2)
cv2.waitKey(1000)
...
imgOut =  cv2.warpPerspective(img,matrix,(width,height))
    #to take 4 points on image and make it proper as cam scanner documnet scanning
...
cv2.namedWindow("Trackbars")
    #to createa a window with name 'Trackbars'
...
cv2.createTrackbar("Val Max","Trackbars",255,255,empty)
    ...
    #to cretae a tracbar inside window which ranges from 0-179
...
while (count < 1000):
    ...
    cv2.imshow("Commbination", imgHSV)
    cv2.imshow("Commbination", imgResult)
...
cv2.imshow("Commbination", shapes)
cv2.waitKey(1000)
cv2.imshow("Commbination", shapeGray)
cv2.waitKey(1000)
cv2.imshow("Commbination", shapeBlur)
cv2.waitKey(1000)
